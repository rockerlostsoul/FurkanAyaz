...
cout << "normlanmisi " << a11/diz <<   a12/diz  <<   a13/diz  <<   a14/diz  <<  a15/diz   <<  endl;
cout << "normlanmisi " << a21/diz <<   a22/diz  <<   a23/diz  <<   a24/diz  <<  a25/diz   <<  endl;
cout << "normlanmisi " << a31/diz <<   a32/diz  <<   a33/diz  <<   a34/diz  <<  a35/diz   <<  endl;
cout << "normlanmisi " << a41/diz <<   a42/diz  <<   a43/diz  <<   a44/diz  <<  a45/diz   <<  endl;
cout << "normlanmisi " << a51/diz <<   a52/diz  <<   a53/diz  <<   a54/diz  <<  a55/diz   <<  endl;
}
return 0;}
